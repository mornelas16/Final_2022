...
# Coding Details
First, the variables from FinalData needed to be changed from character variables into factor variables. The appropriate dplyr code was used to do this, the code used to achieve this was: 

FinalData <- FinalData %>%
mutate(across(where(is.character), as.factor))

Next, specific subgroups had to be separated from the broader categories in order to be studied properly. Males and Females were separated into subgroups, as well as a persons sexual orientation and people that participate in drug use. All of these categories were isolated to see whether or not each particular populations should or should not take the  new covid921 vaccine.
...
These numerical results show specific percentages of females that got covid921 after being given the placebo and the vaccine. Among the females, 57% got covid921 after taking the vaccine, while the approximately 43% of females that were given the placebo contracted covid921. The vaccine is clearly ineffective in preventing covid921 in females and it is not recommended. Those who took the vaccine were much more likely to contract covid921. The odds of getting covid921 while taking the vaccine are 3:2. The females that were given the vaccine were one and a half times more likely to get covid921 than those who were given the placebo.
...
From the data above the information we are focusing on the most are the results we gathered from the Fisher's Exact test. The p-value displayed above is pretty small with the value of 0.005. This small number, shows us that it is very unlikely that these results will occur by chance.

The null hypothesis predicted that the deaths related to covid921 are independent of sex. Since it is clear that sex does play a role in the death rate of individuals, the alternative hypothesis, that there is a correlation between covid921 deaths and sex, is the favorable option.

The odd ratio above illustrates a ratio of 0.74. This means that the females who received the vaccine were one and a half times more likely to get covid921 than those who were given the placebo. 
...
The odds ratio is approximately how effective the vaccine is. The odds ratio for the female population can be seen above as 43. The effectiveness confidence interval for the female population is between 37.34 to 47.86.
...
From the data above the information we are focusing on the most are the results we gathered from the Fisher's Exact test. The p-value displayed above is pretty small with the value of 0.00000001. This extremely small number, shows us that it is highly unlikely that these results will occur by chance.
...
The odd ratio above illustrates a ratio of 0.16. This means that the LGBTQ members who received the vaccine were six times more likely to get covid921 than those who were given a placebo. 
...
The covid921 vaccine was very effective in protecting males against the contraction of the disease. The covid921 effectiveness was `r effectivenessmale` for males.

The covid921 vaccine was unsuccessful in protecting females against covid921.The covid921 effectiveness was `r effectivenessfemale`.

The covid921 vaccine was not effective in treating people who identified as LGBTQ. The individuals who identified as LGBTQ and took the vaccine were six times as likely to get covid-19 than those taking the placebo.The covid-19 effectiveness was `r effectivenessgays` for LGBTQ individuals.

The individuals that were drug users were ineffectively protected by the vaccine.

The drug users  that took the vaccine were five times as likely to get covid921 than those taking the placebo.The covid921 effectiveness was `r effectivenessdrug` for drug users.
